...
- "Outline the process for [specific operation]."
...
- "Why is my SQL query not returning any results? [insert query]."
...
- "How can we integrate our payment gateway with the existing e-commerce platform?"
